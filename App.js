      ...
      card: {
        ...
        gridElements: {
          infoWithStyle: {
            ...
            text: "302 Restaurants to explore",
            headerStyling: {
              textSize: 15,
    ...
    card: {
      card: {
        ...
        info: {
          ...
          name: "Big Bowl",
          cloudinaryImageId:
            "RX_THUMBNAIL/IMAGES/VENDOR/2024/6/22/deff0d02-ca1d-4ef9-9d62-b0cbeabf33d3_485442.JPG",
          ...
          promoted: true,
          adTrackingId:
            "cid=31207106~p=0~adgrpid=31207106#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=485442~plpr=COLLECTION~eid=ce004c31-4f32-4861-89e6-76d2e53a7078~srvts=1752820909860~collid=83639",
          sla: {
            deliveryTime: 44,
            lastMileTravel: 2.2,
          ...
          availability: {
            nextCloseTime: "2025-07-19 02:00:00",
            opened: true,
          },
          badges: {},
          isOpen: true,
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=485442&source=collection&query=Biryani",
    ...
    card: {
      card: {
        ...
        info: {
          ...
          cloudinaryImageId: "nh0bpfpxsuo4jta7lh14",
          locality: "Ashok Nagar",
          ...
          availability: {
            nextCloseTime: "2025-07-19 01:00:00",
            opened: true,
          },
          badges: {
            imageBadges: [
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=21476&source=collection&query=Biryani",
          text: "RESTAURANT_MENU",
          type: "DEEPLINK",
        },
        widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food",
    ...
    card: {
      card: {
        ...
        info: {
          ...
          cloudinaryImageId: "0f2f7ca7ac66109245a715aa68f2e6be",
          locality: "Vadapalani",
          areaName: "Saligramam",
          costForTwo: "₹250 for two",
          cuisines: [
          ...
          promoted: true,
          adTrackingId:
            "cid=31010805~p=2~adgrpid=31010805#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=1069604~plpr=COLLECTION~eid=589f172c-c81e-42df-a6a7-dc3c6f3bd376~srvts=1752820909860~collid=83639",
          sla: {
            deliveryTime: 21,
            lastMileTravel: 2.7,
            serviceability: "SERVICEABLE",
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=1069604&source=collection&query=Biryani",
          text: "RESTAURANT_MENU",
          type: "DEEPLINK",
        },
        widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food",
  ...
  },
  {
    card: {
      card: {
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=631166&source=collection&query=Biryani",
          text: "RESTAURANT_MENU",
          type: "DEEPLINK",
        },
        widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food",
    ...
    card: {
      card: {
        ...
        info: {
          ...
          promoted: true,
          adTrackingId:
            "cid=31010963~p=6~adgrpid=31010963#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=27788~plpr=COLLECTION~eid=b0f85c39-9ccc-4910-b869-deca3577e5e6~srvts=1752820909860~collid=83639",
          sla: {
            deliveryTime: 24,
            lastMileTravel: 1.4,
            serviceability: "SERVICEABLE",
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=27788&source=collection&query=Biryani",
          text: "RESTAURANT_MENU",
          type: "DEEPLINK",
        },
        widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food",
  ...
  },
  {
    card: {
      card: {
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=52155&source=collection&query=Biryani",
          text: "RESTAURANT_MENU",
          type: "DEEPLINK",
        },
        widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food",
    ...
    card: {
      card: {
        ...
        info: {
          ...
          name: "Samco",
          cloudinaryImageId:
            "FOOD_CATALOG/IMAGES/CMS/2024/10/2/fb138e60-3391-4506-9314-75779089fdb6_a454c8b9-29a3-468a-af02-ae3327fb72f0.jpg",
          locality: "Teynampet",
          areaName: "Teynampet",
          costForTwo: "₹500 for two",
          cuisines: [
          ...
          promoted: true,
          adTrackingId:
            "cid=31010705~p=7~adgrpid=31010705#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=9097~plpr=COLLECTION~eid=bd547301-f913-46a2-a77a-a6e0794116dc~srvts=1752820909860~collid=83639",
          sla: {
            deliveryTime: 46,
            lastMileTravel: 6.3,
            serviceability: "SERVICEABLE",
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=9097&source=collection&query=Biryani",
          text: "RESTAURANT_MENU",
          type: "DEEPLINK",
        },
        widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food",
...
const Body = () => (
  <div className="body">
    ...
    <div className="res-container">
      {resList.slice(3).map((restaurant, index) => (
        <RestaurantCard
